...
def createAccounts():
	...
	if ACCOUNTS < 1:
		return ""
	query = ''
	string = "INSERT INTO \"api_account\"(\"username\", \"about_me\", \"email\", \"first_name\", \"last_name\", \"last_login\", \"password\", \"profile_image\", \"cover_image\", \"secret_key\", \"statistics\", \"valid\")"
	string += "VALUES(\'{username}\', \'Hi!, My name is {first} {last}!\', \'{last}.{first}@email.com\', \'{first}\', \'{last}\', \'{date}\', \'\', \'profile/generic-profile.png\', \'cover/generic-cover.png\', \'\',\'\', \'False\');\n"
